...
# data drive.
import os 
drive = "/mnt/iusers01/jf01/mbcx9cd4/rds_lightform/SXRD_analysis_packages/"

# properties of the data files.
datafile_directory = drive + 'continuous-peak-fit-analysis/example-data/rawdata_6/103845-pilatus2M-files'
...
Calib_param    = drive + 'continuous-peak-fit-analysis/example-calibration/103852-calibration/calibration-dioptas/calibration_103852.poni'
Calib_mask     = drive + 'continuous-peak-fit-analysis/example-calibration/103852-calibration/calibration-dioptas/mask_103852.mask'
Calib_pixels = 172
...
# output settings
Output_directory   = drive + 'example_analysis/103845/texture-cpf-stage-scan/103845-cpf-output/'
Output_type        = 'MultiFit' #'DifferentialStrain' # differential strain option gives the principal stress/strain axis
Output_NumAziWrite = 360# Input parameters for Ti64
