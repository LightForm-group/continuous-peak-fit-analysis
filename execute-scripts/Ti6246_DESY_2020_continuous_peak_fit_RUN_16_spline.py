...
import cpf
input_filepath = "../../../SXRD_analysis/desy_2020/experiment16-deformation/fourier-peak-analysis-correction/"
input_filename = "INPUT_DESY-2020_Ti6246_High_Temp_14alpha_4beta_iCSF_02.py"
